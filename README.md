...
```sh
  git clone https://github.com/JacintaNgwu/Recipe-App
...
Feel free to check the [issues page](https://github.com/JacintaNgwu/Recipe-App/issues).
...
I would like to thank microverse for providing all the resources to buld this app. I would also like to thank my coding partner Yetemegn Lemma for her contribution to this project.
